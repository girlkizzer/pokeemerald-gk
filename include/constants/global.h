...
#define MAX_MON_INNATES 3 // (Minimum 0) The max number of Innates that are enabled in gameplay. Could be altered in game if you add an option for it.
#define MAX_MON_ITEMS 2 // (Minimum 1) Number of items that can be held by a pokemon during gameplay
