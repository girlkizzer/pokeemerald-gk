...
bool32 CanAbilityBlockMove(enum BattlerId battlerAtk, enum BattlerId battlerDef, u32 move, enum ResultOption option);
...
bool32 HasDazzlingAbility(enum BattlerId battler);
...
u32 GetBattlerItemHoldEffect(enum BattlerId battler, enum Item item);
