...
#define FG_VAGUE_FISH_FOR_OBSCURED          TRUE   // If TRUE, uses a vague fish shape instead of a blacked out Pokemon icon when obscured.
...
#define FG_FLAG_FIRST_TIME_TUTORIAL         FLAG_FISHING_GAME_FIRST       // Replace 0 with an unused flag to display a short tutorial the first time the game is played.
