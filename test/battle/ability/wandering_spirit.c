...
SINGLE_BATTLE_TEST("Wandering Spirit copied ability triggers on fainted mon")
{
    GIVEN {
...
SINGLE_BATTLE_TEST("Wandering Spirit copied ability triggers on fainted mon (Traits)")
{
    GIVEN {
